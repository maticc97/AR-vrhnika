...
function startAnimation() {
  ...
  if (this.model) {
    //
    this.secModel.setAttribute('rotation',{x: 0 ,y: 90 ,z: -90})
    this.secModel.setAttribute('scale',{x: 0.4 ,y: 0.4 ,z: 0.4})
    ...
    //set to original position
      ...
      this.model.setAttribute('scale',{x: 0.4 ,y: 0.4 ,z: 0.4})
  }
...
function zoomin(){
  ...
  if(this.model.getAttribute('visible')){
    let c = this.model.getAttribute('scale');
    this.model.setAttribute('scale',{x: c.x*1.1 ,y: c.y*1.1 ,z: c.z*1.1});
  }
    else if(this.secModel.getAttribute('visible')){
      let a = this.model.getAttribute('scale');
      this.secModel.setAttribute('scale',{x: a.x*1.4 ,y: a.y*1.4 ,z: a.z*1.4});
  }
...
function zoomout(){
  ...
  if(this.model.getAttribute('visible')){
    let c = this.model.getAttribute('scale');
    this.model.setAttribute('scale',{x: c.x*0.9 ,y: c.y*0.9 ,z: c.z*.9});
  }
    else if(this.secModel.getAttribute('visible')){
      let a = this.model.getAttribute('scale');
      this.secModel.setAttribute('scale',{x: a.x*0.6 ,y: a.y*0.6 ,z: a.z*0.6});
  }
}
